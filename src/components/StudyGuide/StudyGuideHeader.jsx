 ...
 * @param {Array} props.sectionContent - Current section content for summarization
 */
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <span className="hidden sm:inline font-medium text-sm text-slate-600 dark:text-slate-300">Back</span>
        </button>
      ...
      <div className="flex items-center gap-1 sm:gap-2">
        {/* Summarize Button - Study tab only */}
        {activeTab === 'study' && (
          <SummarizeButton
            sectionTitle={currentSection?.title || topic?.name || 'Content'}
